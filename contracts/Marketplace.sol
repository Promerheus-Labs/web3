...
contract MarketPlace is Ownable {
    ...
    constructor (address p_tokenContract, address p_nftsContract) Ownable(msg.sender) {
        s_token = IERC20(p_tokenContract);
    ...
    function buy(uint256 p_nftID, uint256 p_price) public  securityFrontRunning(p_nftID) {
        ...
        require(s_token.transferFrom(msg.sender, address(this), (price / 100) * 1), "Error transfer fee"); // fee 1%
